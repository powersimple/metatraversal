var localhost = 'https://metatraversal/' // SET local dev url here
...
function browser() {
    ...
    watch('./app/js/aframe/**/*.js', aframe).on('change', browserSync.reload);
